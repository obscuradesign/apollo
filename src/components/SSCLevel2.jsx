...
export const SSCLevel2 = React.memo(function SSCLevel2({ getColor, onHover, onClick }) {
    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" id="floor_2" data-name="floor 2" viewBox="0 0 720 720">
            ...
            <path id="mech-room" d="M380.65 164.85h24.33v58.83h-24.33z" style={{ fill: "#58595b" }} />
            ...
            <path id="mech-room2" d="M220.41 569.72h15.26v6h18v25.3h-33.26z" style={{ fill: "#58595b" }} />
            <path id="ssc-183" d="M46.15 430.93h171.26v206.55h-25.56l-34.7 15.26H97.4l-37.68-20.26V478.8H46.15z" {...r("ssc-183")} />
            <path id="mech-room3" d="M142.35 430.93h53.94v25.37h-53.94z" style={{ fill: "#58595b" }} />
            <path id="ssc-297b" d="M74.85 430.93h23.61v25.37H74.85z" style={{ fill: "#58595b" }} />
            <path id="ssc-297c" d="M101.46 430.93h37.89v25.37h-37.89z" style={{ fill: "#58595b" }} />
            <g id="walls">
